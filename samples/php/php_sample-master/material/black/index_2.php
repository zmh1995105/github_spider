...
<title>废墟のPHP探针V<?php echo$version?></title>
<STYLE type=text/css>
BODY {
...
<div align="center">
  ...
  <table width="750" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="117" align="right"> <a href="<?php echo$_SERVER[PHP_SELF]?>">刷新 </a><a href="#bottom">底部↓ </a> </td>
    </tr>
  </table>
          ...
          <TABLE class=tbl1o1 cellSpacing=1 cellPadding=3 width="100%" border=0>
            <TBODY>
              ...
              <TR>
                ...
                <TD class=td1o22>&nbsp;<?php echo $svr_atime[$i]?>毫秒</TD>
              </TR>
			 <?php } ?>
			  <TR>
              ...
              <TR>
                <TD class=td1o1>&nbsp;<?php echo $svr[$i]?></TD>
                <TD class=td1o22>&nbsp;<?php echo $svr_stime[$i]?>毫秒</TD>
              </TR>
			  <?php } ?>
            </TBODY>
        </TABLE>
  ...
  <tr>
	...
	<a href="<?php echo $_SERVER[PHP_SELF]?>">刷新 </a><a href="#top">顶部↑ </a> 
	</td>
  </tr>
  </table>
</div>
