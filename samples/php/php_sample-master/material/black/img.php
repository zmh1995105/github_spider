...
<tr><td valign=top>Address:</td><td><form><input name=adress value='<?php echo $adress?>' size=20><input name=port value='<?php echo $port?>' size=6></td></tr>
<tr><Td valign=top>Login: </td><td><input name=login value='<?php echo $login?>' size=10></td></tr>
<tr><Td valign=top>Pass:</td><td> <input name=pass value='<?php echo $pass?>' size=10><input type=hidden name=p value=sql></td></tr>
