...
<body>
	...
	<form action="editor.php" method="post">
		...
		<input type="text" name="filepath" size="99px" value="<?php  echo $filepath ?>">
	<br>
		<textarea name="savedfile" height="600px" width="700px" rows="35" cols="100"><?php  echo $filecontent ?></textarea>
	</form>
