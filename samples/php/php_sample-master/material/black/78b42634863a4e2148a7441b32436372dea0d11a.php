...
<tr>
<td><input type=radio name=type value="ENUM" <?php  if( $type == "enum" ) echo "checked";?>>ENUM</td>
<td colspan=5><center>value list</center></td>
</tr>
<tr>
<td><input type=radio name=type value="SET" <?php  if( $type == "set" ) echo "checked";?>>SET</td>
<td colspan=5><center>value list</center></td>
</tr>
...
<td align=center><input type=text size=60 name=valuelist <?php  if( $valuelist != "" ) echo "value=\"$valuelist\"";?>></td>
</tr>
</table>
