...
<form method=post action="" name=f> 
    <textarea name=info style="width:550px; height:200px;"><?php  if(isset($_POST['info'])) echo $_POST['info']; else echo "mail | pass" ?></textarea> <textarea name="socks" id="socks" style="width:350px; height:200px;"/><?php  if(isset($_POST['socks'])) echo $_POST['socks']; else echo "" ?></textarea><br> 
...
if(isset($_POST['info'])){ 
    ...
    CHECK ACCOUNT IN SITE: <font color="#FF0000"><?php  echo $plan; ?></font><br>------------------------- o0o -------------------------<br  /> 
    ...
    <table border="1"> 
        ...
        <?php  
            for($i=0 ; $i<$TOTAL; $i++){  
                ...
                ?> 
                    <tr> 
                        <td align="center"><?php echo $id=$i+1 ?></td> 
