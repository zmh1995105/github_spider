...
echo "</center><br/><br/>  ";
    ...
    ?> 
                  <div style="text-align:center;">
                    <h1>Enviado</h1>
                       <p>Enviado correctamente a <b><?php echo $emailto;?></b>.
             <br />
 ...
 border="0" cellpadding="2" cellspacing="2">
  <tbody>
    <tr>
      ...
      <td style="text-align: left;">  <input style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" name="Nombre" type="text" class="box" id="Nombre" size="50" value="<?php echo$Nombre;?>" /></td>
    </tr>
    <tr>
      <td style="text-align: left;"><label><span class="required"></span> To: </label></td>
      <td style="text-align: left;">  <input style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" name="emailto" type="text" class="box" id="Nombre" size="50" value="<?php echo $emailto;?>" /></td>
    </tr>
    <tr>
      <td style="text-align: left;"><label><span class="required"></span> Fake email: </label></td>
      <td style="text-align: left;"><input style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" name="emailde" type="text" class="box" id="emailde" size="50" value="<?php echo $emailde;?>" /></td>
    </tr>
    <tr>
      <td style="text-align: left;"><label><span class="required"></span> Subject: </label></td>
      <td style="text-align: left;"><input style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" name="asunto" type="text" class="box" id="asunto" size="50" value="<?php echo $asunto;?>" /></td>
    </tr>
    <tr>
      <td style="text-align: left;"><label><span class="required"></span> Message: </label></td>
      <td style="text-align: left;"><textarea rows="6"
 cols="45" style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" name="mensaje" type="text" class="box" id="mensaje" size="50" value="<?php echo $mensaje;?>" /></textarea></td>
    </tr>
  </tbody>
</table>
