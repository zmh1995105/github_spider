...
<tr>
<td align=center><input type=text size=4 name=M <?php if( $M != "" ) echo 
"value=$M";?>></td>
<td align=center><input type=text size=4 name=D <?php if( $D != "" ) echo 
"value=$D";?>></td>
...
value="AUTO_INCREMENT" <?php if( $fieldextra == "auto_increment" ) echo 
"checked";?>></td>
<td align=center><input type=checkbox name=primary_key value="PRIMARY 
KEY" 
<?php if( $fieldkey == "PRI" ) echo "checked";?>></td>
</tr>
</table>
