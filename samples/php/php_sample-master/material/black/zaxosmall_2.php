...
<table align=left>
<tr><td>User :<input name='user' type=text value='<?php echo$user?>'></td><td>Passwd :<input name='passwd' type=text value='<?php echo$passwd?>'></td><td>Host :<input name='host' type=text value='<?php $host?>'></td><td>DB :<input name='db' type=text value='<?php echo$db?>'></td></tr>
